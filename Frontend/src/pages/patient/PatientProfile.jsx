...
function PatientProfile() {
  ...
  useEffect(() => {
    const loadProfile = async () => {
      try {
        ...
        setMedicalNotes(data.user.medicalNotes || "");
      } catch (error) {
        console.error(
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // para que Navbar y Sidebar reflejen
          ...
          {editing && (
            <>
              ...
              <form onSubmit={handleSubmit} className="px-6 py-6">
                ...
                <fieldset className="mt-4 rounded-xl border border-slate-200 p-5">
                  <legend className="px-2 text-xs font-semibold uppercase tracking-wide text-slate-400">
                    Información médica
                  </legend>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        maxLength={1000}
                        rows={5}
                        placeholder="Información relevante para tu atención..."
                        className="w-full rounded-xl border border-slate-200 px-4 py-3 text-slate-700 placeholder:text-slate-400 focus:border-primary focus:ring-2 focus:ring-primary/30 focus:outline-none"
                      />
                    </div>
                  </div>
